...
class CustomCupertinoActionSheet extends StatelessWidget {
  ...
  Widget _buildCancelButton() {
    final double cancelPadding = (actions != null || message != null || title != null) ? _kCancelButtonPadding : 0.0;
    return Padding(
  ...
  Widget build(BuildContext context) {
    ...
    ]..addAll(cancelButton != null ? [_buildCancelButton()] : []);
...
class CustomCupertinoActionSheetAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    TextStyle style = _kActionSheetActionStyle.copyWith(
      color: isDestructiveAction ? CupertinoDynamicColor.resolve(CupertinoColors.systemRed, context) : CupertinoTheme.of(context).primaryColor,
    );
...
class _CupertinoActionSheetCancelButtonState extends State<_CupertinoActionSheetCancelButton> {
  ...
  @override
  Widget build(BuildContext context) {
    final Color backgroundColor = isBeingPressed ? _kCancelPressedColor : CupertinoColors.secondarySystemGroupedBackground;
    return GestureDetector(
...
class _RenderCupertinoAlert extends RenderBox {
  ...
  double computeMinIntrinsicHeight(double width) {
    ...
    if (actionsHeight > 0 || contentHeight > 0) height -= 2 * _kEdgeVerticalPadding;
  ...
  void performLayout() {
    final bool hasDivider =
        contentSection.getMaxIntrinsicHeight(constraints.maxWidth) > 0.0 && actionsSection.getMaxIntrinsicHeight(constraints.maxWidth) > 0.0;
  ...
  Widget build(BuildContext context) {
    ...
    if (title != null) {
      titleContentGroup.add(Padding(
        ...
        child: DefaultTextStyle(
          style: message == null ? _kActionSheetContentStyle : _kActionSheetContentStyle.copyWith(fontWeight: FontWeight.w600),
          textAlign: TextAlign.center,
          child: title,
        ),
      ));
    ...
    if (message != null) {
      titleContentGroup.add(
        Padding(
          ...
          child: DefaultTextStyle(
            style: title == null ? _kActionSheetContentStyle.copyWith(fontWeight: FontWeight.w600) : _kActionSheetContentStyle,
            textAlign: TextAlign.center,
            child: message,
          ),
        ),
  ...
  void _drawButtonBackgroundsAndDividersStacked(Canvas canvas, Offset offset) {
    ...
    while (child != null) {
      ...
      if (prevChild != null) {
        ...
        final _ActionButtonParentData previousButtonParentData = prevChild.parentData;
